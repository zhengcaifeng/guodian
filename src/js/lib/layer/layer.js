...
!function (e, t) {
    ...
    r.prompt = function (e, t) {
        ...
        var s, l = 2 == e.formType ? '<textarea class="layui-layer-input"' + a + ">" + (e.value || "") + "</textarea>" : function () {
            return '<input type="' + (1 == e.formType ? "text" : "text") + '" class="layui-layer-input" placeholder="请输入" value="' + (e.value || "") + '">'
        }(), f = e.success;
        ...
        i = t, n = i(e), l.html = i("html"), r.open = function (e) {
            ...
            // if(undefined !== g_data){
            //     if(g_data.fold){
            //         $('.tab_spread', window.parent.document).hide();
            //         $('.tab_fold', window.parent.document).show();
            //         $('.container', window.parent.document).css('margin-left','40px');
            //     }
            //     g_data.fold = false;
            // }
            return t.index
